...
var Guia = (function () {
    ...
    var procesosData = {
        "recepcion-repartidor-seur": {
            ...
            tipo: "repartidor",
            pasos: [
                { imagen: "img/fotos-con-circulos/1.webp", texto: "Pulsa <strong>REPARTIDOR</strong>" },
                { imagen: "img/fotos-con-circulos/5.webp", texto: "Pulsa <strong>RECEPCION DE PAQUETES</strong>" },
                { imagen: "img/fotos-con-circulos/7.webp", texto: "Pulsa <strong>SEUR</strong>" },
                { imagen: "img/fotos-con-circulos/9.webp", texto: "Pulsa el <strong>boton grande</strong>.<br>Escanea cada paquete." },
        ...
        "recepcion-repartidor-tipsa": {
            ...
            pasos: [
                { imagen: "img/fotos-con-circulos/1.webp", texto: "Pulsa <strong>REPARTIDOR</strong>" },
                { imagen: "img/fotos-con-circulos/5.webp", texto: "Pulsa <strong>RECEPCION DE PAQUETES</strong>" },
                { imagen: "img/fotos-con-circulos/8.webp", texto: "Pulsa <strong>TIPSA</strong>" },
                { imagen: "img/fotos-con-circulos/9.webp", texto: "Pulsa el <strong>boton grande</strong>.<br>Escanea cada paquete." },
                { imagen: null, texto: "Pulsa <strong>CONTINUAR</strong>" }
            ],
            mensajeExito: "Los paquetes estan guardados.",
        ...
        "recogida-repartidor": {
            ...
            pasos: [
                { imagen: "img/fotos-con-circulos/1.webp", texto: "Pulsa <strong>REPARTIDOR</strong>" },
                { imagen: "img/fotos-con-circulos/6.webp", texto: "Pulsa <strong>RECOGIDA DE PAQUETES</strong>" },
                { imagen: "img/fotos-con-circulos/7.webp", texto: "Pulsa <strong>SEUR</strong> o <strong>TIPSA</strong>" },
                { imagen: "img/fotos-con-circulos/9.webp", texto: "Escanea cada paquete que se lleva." },
                { imagen: null, texto: "Pulsa <strong>CONTINUAR</strong>" }
            ],
        ...
        "deposito-etiqueta": {
            ...
            tipo: "cliente",
            pasos: [
                { imagen: "img/fotos-con-circulos/2.webp", texto: "Pulsa <strong>CLIENTE</strong>" },
                { imagen: "img/fotos-con-circulos/4.webp", texto: "Pulsa <strong>DEPOSITO DE PAQUETES</strong>" },
                { imagen: "img/fotos-con-circulos/10.webp", texto: "Pulsa <strong>Una etiqueta de envio</strong>" },
        ...
        "deposito-qr": {
            ...
            pasos: [
                { imagen: "img/fotos-con-circulos/2.webp", texto: "Pulsa <strong>CLIENTE</strong>" },
                { imagen: "img/fotos-con-circulos/4.webp", texto: "Pulsa <strong>DEPOSITO DE PAQUETES</strong>" },
                { imagen: "img/fotos-con-circulos/11.webp", texto: "Pulsa <strong>Un codigo QR</strong>" },
        ...
        "entrega-cliente": {
            ...
            pasos: [
                { imagen: "img/fotos-con-circulos/2.webp", texto: "Pulsa <strong>CLIENTE</strong>" },
                { imagen: "img/fotos-con-circulos/3.webp", texto: "Pulsa <strong>RECOGIDA DE PAQUETES</strong>" },
